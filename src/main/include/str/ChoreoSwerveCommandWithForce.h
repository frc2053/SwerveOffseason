...
class ChoreoSwerveCommandWithForce
 ...
 public:
   ...
   *  ChassisSpeeds
   * @param outputXForce a function that the modules predicted force in the field relative x direction
   * @param outputYForce a function that the modules predicted force in the field relative ys direction
  ...
  ChoreoSwerveCommandWithForce(
      choreolib::ChoreoTrajectory trajectory, std::function<frc::Pose2d()> poseSupplier,
